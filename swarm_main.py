...
class SwarmCoreController:
    ...
    def process_sensors(self,
        ...
        # Preserve concept in notes for training, append coordinates
        concept_note = decision.get('concept', '')
        self.logger.log(sensors, decision, notes=f"{concept_note} x:{robot_x:.0f},y:{robot_y:.0f}")
